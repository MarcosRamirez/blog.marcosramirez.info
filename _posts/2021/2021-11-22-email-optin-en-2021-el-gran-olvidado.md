...
pin: false
toc: true
excerpt: "Denuncio una mala praxis extendida en empresas e instituciones: el envío de correos electrónicos con información confidencial sin un proceso previo de Opt-In. Cuando das tu email a una empresa, deberían enviarte un mail de confirmación para validar que realmente es tuyo. Si no lo hacen y te llegan correos con información sensible (datos bancarios, reservas de vuelos, información escolar de hijos, facturas), podrían estar cometiendo un delito. Explico cómo crear automatizaciones con Zapier para gestionar este problema y mi iniciativa de crear un 'salón de la vergüenza' para empresas que lo practican."
...
Compártelo si te ha gustado. ¿Has sufrido este problema? Cuéntame.
