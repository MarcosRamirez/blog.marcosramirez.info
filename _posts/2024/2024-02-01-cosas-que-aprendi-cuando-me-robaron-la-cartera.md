...
2. Llevar un [localizador en la cartera](https://amzn.to/3SmBNUF){:target="_blank"}. Un [localizador como este](https://amzn.to/3SmBNUF){:target="_blank"} puede ayudarte a encontrar tu cartera si te la roban. Y de paso, al menos en mi caso, a dar un escarmiento al espabilado.
