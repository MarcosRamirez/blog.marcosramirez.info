...
pin: false
toc: true
excerpt: Presento un balance de Enero 2025, centrado en el desarrollo de agentes de voz inteligentes con capacidad de agendamiento humano y el relanzamiento tecnológico de mi web de servicios. Comparto mis aprendizajes sobre herramientas como Astro, TailwindCSS y VAPI, además de reflexiones sobre la optimización de la agenda mediante consultorías breves y la experimentación con nuevos modelos de IA, marcando un ritmo sólido para los objetivos del año.
permalink: /:slug/ 
---
