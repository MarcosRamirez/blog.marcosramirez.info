...
tags: [homelab, servidores, docker, redes]
pin: false
toc: true
excerpt: Realizo un recorrido detallado por mi infraestructura tecnológica doméstica y los servicios que autogestiono en mi día a día. Desde el almacenamiento masivo con TrueNAS y centros multimedia como Plex y Jellyfin, hasta la seguridad de red mediante piHole y WireGuard, detallo cómo utilizo Docker para orquestar un ecosistema de automatización, domótica y bases de datos, adelantando además mis planes para integrar un asistente de voz local impulsado por Inteligencia Artificial.
