...
Antes de entrar en detalles, tienes que tener claro qué tipo de jugador eres. Si vas a ser ofensivo, tu prioridad desde el minuto uno es generar recursos para financiar tropas. Los jugadores defensivos pueden permitirse un crecimiento más lento porque su objetivo es ahorrar recursos para construir murallas y tropas defensivas. Los ofensivos, en cambio, necesitan flujo constante de recursos para entrenar tropas de ataque.

Esta guía está orientada específicamente a jugadores ofensivos. Los defensivos tienen otras prioridades que cubriremos en otra entrega.

## Los primeros puntos del héroe: distribución estratégica

Nada más crear tu cuenta, tu héroe tiene varios puntos por distribuir. La pregunta del millón: ¿en qué los gastas? Para un jugador ofensivo, la respuesta depende del tipo de servidor.

### Estrategia para servidores nuevos o con muchos animales en los oasis
...
## Edificios prioritarios: qué construir y cuándo

En los primeros días, tu lista de construcción debe seguir un orden muy específico. Este es el enfoque que más me ha funcionado en mis más de 12 años jugando:

### Edificio principal y cuartel
...
### Granero y almacén: tu red de seguridad

Parece menos glamoroso, pero construir el granero y el almacén a tiempo puede salvarte de perder miles de recursos. Cuando estás empezando, tu capacidad de almacenamiento es muy limitada. Si te atacan y tienes recursos acumulando, lo pierdes todo.

Mi consejo es simple: construye el granero y el almacén lo suficientemente altos para cubrir el tiempo que vas a estar desconectado. Si planeas dormir 8 horas, asegúrate de que tu almacenamiento pueda contener la producción de esas 8 horas más un margen de seguridad. Esto es especialmente importante los primeros días cuando todavía estás aprendiendo a gestionar los tiempos de conexión.

### Residencia: tu puerta a la expansión
...
Aquí viene el consejo clave: **envía ataques cada cinco minutos, como máximo cada diez minutos**. ¿Por qué? Porque los animales en los oasis se regeneran relativamente rápido. Si esperas más de diez minutos entre ataques, muchos animales habrán vuelto y perderás la oportunidad de maximizar tu farmeo.

Otra cosa importante: siempre vas a perder tropas farmeando oasis. Esto es inevitable. Los animales hacen daño y, aunque ganes la batalla, siempre habrá algunas bajas. No te desanimes por esto; es el precio de generar recursos extra. Con el tiempo, tu héroe subirá de nivel y podrá manejar oasis más difíciles con menos pérdidas.
...
Ten siempre una lista activa y funcionando. El farmeo constante de oasis es lo que te da el flujo de recursos necesario para mantener el cuartel produciendo 24/7.
...
**Gold Club es absolutamente necesario**. ¿Por qué? Porque sin Gold Club NO puedes crear listas de granjas (farmlists), y sin farmlists es prácticamente imposible mantener el farmeo constante de oasis y jugadores que necesitas como jugador ofensivo.

Las farmlists te permiten automatizar tus ataques en secuencia sin tener que seleccionar cada objetivo manualmente. Imagina tener que enviar 50 ataques uno por uno cada vez que te conectas: es inalcanzable. Con Gold Club, configuras la lista una vez y el juego ataca automáticamente en bucle.
...
### Criterios para tu segunda aldea

Busca una aldea que cumpla estos requisitos:

1. **Al menos 150% de bonus por oasis**: Los oasis pueden darte hasta un 50% de bonificación cada uno. Intenta encontrar una zona donde puedas tener dos oasis con bonificaciones que sumen al menos un 150%. Esto dispara tu producción.

2. **Seguridad**: Busca una zona donde haya pocos jugadores activos cerca. Los primeros días de tu segunda aldea son vulnerables; si te atacan antes de tener defensas, puedes perderla fácilmente.

3. **Ubicación estratégica**: Idealmente, tu segunda aldea debería estar relativamente cerca de tu aldea principal para que los tiempos de viaje sean cortos. Esto te permite mover tropas rápidamente entre ambas aldeas según necesites.

4. **Tipo de aldea**: Un cerealero puro (15 campos de grano) es lo mejor para ofensivos. Puedes renunciar a producción de otros recursos porque tu primera aldea puede compensar, pero el grano extra te permite entrenar muchas más tropas.

## Resumen de la semana uno
...
4. **Días 6-7**: Mejorar residencia a nivel 10, entrenar colonos, preparar los recursos para la segunda aldea.

5. **Día 7+**: Fundar la segunda aldea como cerealero con buen bonus de oasis, seguir creciendo ambas aldeas en paralelo.
...
<details>
<summary>¿Cuántas aldeas debo tener en la primera semana?</summary>
