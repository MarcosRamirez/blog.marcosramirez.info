...
Llevo un tiempo acumulando servicios. Tengo [Home Assistant]({% post_url 2026-06-01-home-assistant-tu-cerebro-de-domotica %}), [AdGuard]({% post_url 2026-05-18-adguard-home-bloqueador-publicidad %}), [Vaultwarden]({% post_url 2026-07-13-vaultwarden-contraseñas-seguras %}), [N8N]({% post_url 2026-04-27-n8n-tu-automatizacion-bajo-tu-control %}), [Immich]({% post_url 2026-06-08-immich-privacidad-tus-fotos %}), [Firefly III]({% post_url 2026-06-15-firefly-iii-finanzas %}), [Paperless NGX]({% post_url 2026-06-29-paperless-ngx-documentos %}), [SearXNG]({% post_url 2026-07-06-searxng-buscador-privado %}). Cada uno en su propio contenedor, actualizándose a su ritmo.
