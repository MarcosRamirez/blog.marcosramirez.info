...
En mi caso, Home Assistant corre en una **máquina virtual** con Home Assistant OS dentro de [Proxmox]({% post_url 2026/2026-05-25-mi-decision-de-usar-proxmox %}){:target="_blank" rel="nofollow noopener"}, con:
