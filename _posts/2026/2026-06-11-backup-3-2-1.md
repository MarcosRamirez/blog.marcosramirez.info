...
Para quien usa [Proxmox]({% post_url 2026/2026-05-25-mi-decision-de-usar-proxmox %}), [Proxmox Backup Server](https://www.proxmox.com/en/proxmox-backup-server) (PBS) es la solución nativa y gratuita.
